...
<html>
<head>
  <title>Latte (female) | Personal-a-Tea Selfie</title>
  ...
  <link rel="stylesheet" type="text/css" href="traits-latte-female.css">
  ...
  <script>
    function checkAvatar() {
      ...
      if (persa == 2 && persb == 0  && persc == 1  && persd == 2 ) {
  ...
  <div id="avatar-generator">
    ...
    <img style="max-width:100%;" src="images/top-logo-blue.png">
      ...
      <div class="buttons-gender">
        <ul>
          <li><a href="latte-male.php" class="round green" id="male-but">Male<span class="round"> <h1>:D</h1> </span></a></li>
      ...
      <div class="buttons-drink">
        <ul>                  
          ...
          <li>
            <a href="latte-female.php" id=latte-but class="current3 round yellow"><div id="latte-but-text">Latte</div>
              <span class="round">
        ...
        <div id="desRadio" class="desRadio" name="desRadio">
          ...
          <form name="fdesign">
            <ul>
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(latte-hongoram-female.jpg)'; 
                  getElementById('personality-a').style.color = '#c44454'; 
                  getElementById('personality-b').style.color = '#c44454'; 
                  getElementById('personality-c').style.color = '#c44454'; 
                  getElementById('personality-d').style.color = '#c44454'; 
                  getElementById('nameMugArea').style.color = '#c44454'">
              ...
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(latte-nostalgia-female.jpg)'; 
              ...
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(latte-paupau-female.jpg)'; 
                  getElementById('personality-a').style.color = '#fff'; 
                  getElementById('personality-b').style.color = '#fff'; 
                  getElementById('personality-c').style.color = '#fff'; 
                  getElementById('personality-d').style.color = '#fff'; 
                  getElementById('nameMugArea').style.color = '#fff'">
                ...
                <ul>
                  <li id="li-top">
                    <a onclick="getElementById('personality-a').innerHTML = 'Reserved'" >
                      <input type="radio" id="a1-option" name="personalitya" value="Reserved" >
                      <label for="a1-option">Reserved</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li>
                    <a onclick="getElementById('personality-a').innerHTML = 'Personable'">
                      <input type="radio" id="a2-option" name="personalitya" value="Personable"> 
                      <label for="a2-option">Personable</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li>
                    <a onclick="getElementById('personality-a').innerHTML = 'Sincere'">
                      <input type="radio" id="a3-option" name="personalitya" value="Sincere"> 
                      <label for="a3-option">Sincere</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-a').innerHTML = 'Helpful'">
                      <input type="radio" id="a4-option" name="personalitya" value="Helpful"> 
                      <label for="a4-option">Helpful</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-a').innerHTML = 'Generous'">
                      <input type="radio" id="a5-option" name="personalitya" value="Generous"> 
                      <label for="a5-option">Generous</label>
                      <div class="check"></div>
                    </a>
                  </li>
                </ul>
          ...
          <div class="radio-container" name="radio-container">
            ...
            <div id="p2">
              <form name="fpersb">
                <ul>
                  <li id="li-top" >
                    <a onclick="getElementById('personality-b').innerHTML = 'Indecisive'" >
                      <input type="radio" id="b1-option" name="personalityb" value="Indecisive" >
                      <label for="b1-option">Indecisive</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li>
                    <a onclick="getElementById('personality-b').innerHTML = 'Timid'">
                      <input type="radio" id="b2-option" name="personalityb" value="Timid"> 
                      <label for="b2-option">Timid</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li>
                    <a onclick="getElementById('personality-b').innerHTML = 'Loyal'">
                      <input type="radio" id="b3-option" name="personalityb" value="Loyal"> 
                      <label for="b3-option">Loyal</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-b').innerHTML = 'Assertive'">
                      <input type="radio" id="b4-option" name="personalityb" value="Assertive"> 
                      <label for="b4-option">Assertive</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-b').innerHTML = 'Bubbly'">
                      <input type="radio" id="b5-option" name="personalityb" value="Bubbly"> 
                      <label for="b5-option">Bubbly</label>
                      <div class="check"></div>
                    </a>
                  </li>
                </ul>
          ...
          <div class="radio-container" name="radio-container">
            ...
            <div id="p3">
              <form name="fpersc">
                <ul>
                  <li id="li-top" >
                    <a onclick="getElementById('personality-c').innerHTML = 'Happy'" >
                      <input type="radio" id="c1-option" name="personalityc" value="Happy" >
                      <label for="c1-option">Happy</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li>
                    <a onclick="getElementById('personality-c').innerHTML = 'Funny'">
                      <input type="radio" id="c2-option" name="personalityc" value="Funny"> 
                      <label for="c2-option">Funny</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li>
                    <a onclick="getElementById('personality-c').innerHTML = 'Empathetic'">
                      <input type="radio" id="c3-option" name="personalityc" value="Empathetic"> 
                      <label for="c3-option">Empathetic</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-c').innerHTML = 'Outgoing'">
                      <input type="radio" id="c4-option" name="personalityc" value="Outgoing"> 
                      <label for="c4-option">Outgoing</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-c').innerHTML = 'Kind'">
                      <input type="radio" id="c5-option" name="personalityc" value="Kind"> 
                      <label for="c5-option">Kind</label>
                      <div class="check"></div>
                    </a>
                  </li>
                </ul>
          ...
          <div class="radio-container" name="radio-container">
            ...
            <div id="p4">
              <form name="fpersd">
                <ul>
                  <li id="li-top">
                    <a onclick="getElementById('personality-d').innerHTML = 'Honest'" >
                      <input type="radio" id="d1-option" name="personalityd" value="Honest" >
                      <label for="d1-option">Honest</label>
                      <div class="check"></div>
                    </a>
                  </li>
