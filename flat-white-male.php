...
<html>
<head>
  <title>Flat White Male | Personal-a-Tea Selfie</title>
  ...
  <link rel="stylesheet" type="text/css" href="traits-flat-white-male.css">
  ...
  <script>
    function checkAvatar() {
      ...
      if (persa == 0 && persb == 4  && persc == 2  && persd == 1 ) {
...
<!----------------------------------------------------Begining of landing page---------------------------------->
  ...
  <div id="avatar-generator">
    ...
    <!--<img style="max-width:100%;" src="/create-your-personal-a-tea-selfie/images/artboard7.2.png">-->
      ...
      <div class="buttons-gender">
        <ul>
          ...
          <li><a href="flat-white-female.php" class="round red" id="female-but">Female<span class="round"> <h1>:D</h1> </span></a></li>
        </ul> 
      </div> <!--buttons-gender-->
      ...
      <div class="buttons-drink">
        <ul>                  
          ...
          <li>
            <a href="flat-white-male.php" id="fw-but" class="current round yellow"><div id="fw-but-text">Flat White</div>
              <span class="round">
        ...
        <div id="desRadio" class="desRadio" name="desRadio">
          ...
          <form name="fdesign">
            <ul>
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(flat-white-digital-male.jpg)'; 
                  getElementById('personality-a').style.color = '#c28f6c'; 
                  getElementById('personality-b').style.color = '#c28f6c'; 
                  getElementById('personality-c').style.color = '#c28f6c'; 
                  getElementById('personality-d').style.color = '#c28f6c'; 
                  getElementById('nameMugArea').style.color = '#c28f6c'">
              ...
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(flat-white-kt-male.jpg)'; 
                  getElementById('personality-a').style.color = '#f5b899'; 
                  getElementById('personality-b').style.color = '#f5b899'; 
                  getElementById('personality-c').style.color = '#f5b899'; 
                  getElementById('personality-d').style.color = '#f5b899'; 
                  getElementById('nameMugArea').style.color = '#f5b899'">
              ...
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(flat-white-paupau-male.jpg)'; 
                  getElementById('personality-a').style.color = '#81bbc5'; 
                  getElementById('personality-b').style.color = '#81bbc5'; 
                  getElementById('personality-c').style.color = '#81bbc5'; 
                  getElementById('personality-d').style.color = '#81bbc5'; 
                  getElementById('nameMugArea').style.color = '#81bbc5'">
