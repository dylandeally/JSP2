...
<html>
<head>
  <title>Loose Leaf Tea (female) | Personal-a-Tea Selfie</title>
  ...
  <link rel="stylesheet" type="text/css" href="traits-loose-leaf-tea-female.css">
  ...
  <script>
    function checkAvatar() {
      ...
      if (persa == 2 && persb == 1  && persc == 0  && persd == 2 ) {
  ...
  <div id="avatar-generator">
    ...
    <img style="max-width:100%;" src="images/top-logo-blue.png">
      ...
      <div class="buttons-gender">
        <ul>
          <li><a href="loose-leaf-tea-male.php" class="round green" id="male-but">Male<span class="round"> <h1>:D</h1> </span></a></li>
      ...
      <div class="buttons-drink">
        <ul>                  
          ...
          <li>
            <a href="loose-leaf-tea-female.php" id="llt-but" class="current3 round yellow"><div id="llt-but-text">Loose Leaf Tea</div>
              <span class="round">
          ...
          <form name="fdesign">
            <div id="align-des-but">
              <ul>
                <li>
                  <a onclick="
                    getElementById('design').style.backgroundImage = 'url(loose-leaf-tea-euro-special-female.jpg)'; 
                ...
                <li>
                  <a onclick="
                    getElementById('design').style.backgroundImage = 'url(loose-leaf-tea-digital-light-female.jpg)'; 
                    getElementById('personality-a').style.color = '#9e0b0f'; 
                    getElementById('personality-b').style.color = '#9e0b0f'; 
                    getElementById('personality-c').style.color = '#9e0b0f'; 
                    getElementById('personality-d').style.color = '#9e0b0f'; 
                    getElementById('nameMugArea').style.color = '#9e0b0f'">
            ...
            <ul>  
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(loose-leaf-tea-digital-dark-female.jpg)'; 
              ...
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(loose-leaf-tea-hongoram-female.jpg)'; 
              ...
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(loose-leaf-tea-nostalgia-female.jpg)'; 
                  getElementById('personality-a').style.color = '#777'; 
                  getElementById('personality-b').style.color = '#777'; 
                  getElementById('personality-c').style.color = '#777'; 
                  getElementById('personality-d').style.color = '#777'; 
