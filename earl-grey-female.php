...
<html>
<head>
  <title>Earl Grey (female)| Personal-a-Tea Selfie</title>
  ...
  <link rel="stylesheet" type="text/css" href="traits-earl-grey-female.css">
  ...
  <script type="text/javascript" >
    function writeComment(e) {
        ...
        document.getElementById('nameMugArea').innerHTML = comment + " Earl Grey";
        e.preventDefault();
        return false;
    } 
  </script>
  ...
  <script>
    function checkAvatar() {
      ...
      if (persa == 1 && persb == 3  && persc == 0  && persd == 4 ) {
        document.getElementById('checkAvatare').innerHTML = '<span style="color:white;">BOOM! Youve Just Won A Prize From Personal-A-Teas.<span style="color:#fff899"> Earl Grey</span> Is Your Personality. <span style="color:#fff899">"Create Selfie"</span> to continue</span>';
        document.getElementById('match').value = 'Yes!';
        return true;
      }
      else {
        document.getElementById('checkAvatare').innerHTML = '<span style="color:white;">Better luck next time! <span style="color:#fff899">"Create Selfie"</span> to continue</sapn>';
...
<!----------------------------------------------------Begining of landing page---------------------------------->
  ...
  <div id="avatar-generator">
    ...
    <img style="max-width:100%;" src="images/top-logo-white.png">
      ...
      <form name="fdrink">
        <input type="hidden" name="drink" id="drink" value="Earl Grey">
      </form>
      ...
      <div class="buttons-gender">
        <ul>
          <li><a href="earl-grey-male.php" class="round green" id="male-but">Male<span class="round"> <h1>:D</h1> </span></a></li>
      ...
      <div class="buttons-drink">
        <ul>                  
          ...
          <li>
            <a href="earl-grey-female.php" id="eg-but" class="current3 round yellow"><div id="eg-but-text">Earl Grey</div>
              <span class="round">
          ...
          <li>
            <a href="flat-white-female.php" id="fw-but" class="round yellow"><div id="fw-but-text">Flat White</div>
              <span class="round">
      ...
      <div id="contentx"> <!--all content below drink buttons except bottom partner logos-->
        ...
        <div id="desRadio" class="desRadio" name="desRadio">
          ...
          <form name="fdesign">
            <ul>
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(earl-grey-hongoram-female.jpg)'; 
                  getElementById('personality-a').style.color = '#80267d'; 
                  getElementById('personality-b').style.color = '#80267d'; 
                  getElementById('personality-c').style.color = '#80267d'; 
                  getElementById('personality-d').style.color = '#80267d'; 
                  getElementById('nameMugArea').style.color = '#80267d'">
              ...
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(earl-grey-nostalgia-female.jpg)'; 
              ...
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(earl-grey-paupau-female.jpg)'; 
                  getElementById('personality-a').style.color = '#1a3360'; 
                  getElementById('personality-b').style.color = '#1a3360'; 
                  getElementById('personality-c').style.color = '#1a3360'; 
                  getElementById('personality-d').style.color = '#1a3360'; 
                  getElementById('nameMugArea').style.color = '#1a3360'">
          ...
          <div class="radio-container" name="radio-container" >
            ...
            <div id="p1">
              <form name="fpersa">
                <ul>
                  <li id="li-top">
                    <a onclick="getElementById('personality-a').innerHTML = 'Motivated'" >
                      <input type="radio" id="a1-option" name="personalitya" value="Motivated" >
                      <label for="a1-option">Motivated</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li>
                    <a onclick="getElementById('personality-a').innerHTML = 'Distinguished'">
                      <input type="radio" id="a2-option" name="personalitya" value="Distinguished"> 
                      <label for="a2-option">Distinguished</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li>
                    <a onclick="getElementById('personality-a').innerHTML = 'Reserved'">
                      <input type="radio" id="a3-option" name="personalitya" value="Reserved"> 
                      <label for="a3-option">Reserved</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-a').innerHTML = 'Aloof'">
                      <input type="radio" id="a4-option" name="personalitya" value="Aloof"> 
                      <label for="a4-option">Aloof</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-a').innerHTML = 'Philosophical'">
                      <input type="radio" id="a5-option" name="personalitya" value="Philosophical"> 
                      <label for="a5-option">Philosophical</label>
                      <div class="check"></div>
                    </a>
                  </li>
                </ul>
          ...
          <div class="radio-container" name="radio-container">
            ...
            <div id="p2">
              <form name="fpersb">
                <ul>
                  <li id="li-top" >
                    <a onclick="getElementById('personality-b').innerHTML = 'Disciplined'" >
                      <input type="radio" id="b1-option" name="personalityb" value="Disciplined" >
                      <label for="b1-option">Disciplined</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li>
                    <a onclick="getElementById('personality-b').innerHTML = 'Neat'">
                      <input type="radio" id="b2-option" name="personalityb" value="Neat"> 
                      <label for="b2-option">Neat</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li>
                    <a onclick="getElementById('personality-b').innerHTML = 'Elegant'">
                      <input type="radio" id="b3-option" name="personalityb" value="Elegant"> 
                      <label for="b3-option">Elegant</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-b').innerHTML = 'Refined'">
                      <input type="radio" id="b4-option" name="personalityb" value="Refined"> 
                      <label for="b4-option">Refined</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-b').innerHTML = 'Arrogant'">
                      <input type="radio" id="b5-option" name="personalityb" value="Arrogant"> 
                      <label for="b5-option">Arrogant</label>
                      <div class="check"></div>
                    </a>
                  </li>
                </ul>
          ...
          <div class="radio-container" name="radio-container">
            ...
            <div id="p3">
              <form name="fpersc">
                <ul>
                  <li id="li-top" >
                    <a onclick="getElementById('personality-c').innerHTML = 'Robust'" >
                      <input type="radio" id="c1-option" name="personalityc" value="Robust" >
                      <label for="c1-option">Robust</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li>
                    <a onclick="getElementById('personality-c').innerHTML = 'Sensitive'">
                      <input type="radio" id="c2-option" name="personalityc" value="Sensitive"> 
                      <label for="c2-option">Sensitive</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li>
                    <a onclick="getElementById('personality-c').innerHTML = 'Charming'">
                      <input type="radio" id="c3-option" name="personalityc" value="Charming"> 
                      <label for="c3-option">Charming</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-c').innerHTML = 'Meticulous'">
                      <input type="radio" id="c4-option" name="personalityc" value="Meticulous"> 
                      <label for="c4-option">Meticulous</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-c').innerHTML = 'Pompous'">
                      <input type="radio" id="c5-option" name="personalityc" value="Pompous"> 
                      <label for="c5-option">Pompous</label>
                      <div class="check"></div>
                    </a>
                  </li>
                </ul>
          ...
          <div class="radio-container" name="radio-container">
            ...
            <div id="p4">
              <form name="fpersd">
                <ul>
                  <li id="li-top">
                    <a onclick="getElementById('personality-d').innerHTML = 'Ceremonious'" >
                      <input type="radio" id="d1-option" name="personalityd" value="Ceremonious" >
                      <label for="d1-option">Ceremonious</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li id="li-top">
                    <a onclick="getElementById('personality-d').innerHTML = 'Traditionalist'">
                      <input type="radio" id="d2-option" name="personalityd" value="Traditionalist"> 
                      <label for="d2-option">Traditionalist</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li id="li-top">
                    <a onclick="getElementById('personality-d').innerHTML = 'Tidy'">
                      <input type="radio" id="d3-option" name="personalityd" value="Tidy"> 
                      <label for="d3-option">Tidy</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  
                  <li id="li-top">
                    <a onclick="getElementById('personality-d').innerHTML = 'Humble'">
                      <input type="radio" id="d4-option" name="personalityd" value="Humble"> 
                      <label for="d4-option">Humble</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  
                  <li id="li-top">
                    <a onclick="getElementById('personality-d').innerHTML = 'Inner-child'">
                      <input type="radio" id="d5-option" name="personalityd" value="Inner-child"> 
                      <label for="d5-option">Inner-child</label>
                      <div class="check"></div>
                    </a>
                  </li>
                </ul>
        ...
        <div class="mesg" >
          <h3 id="bottom-heading">Are You An Earl Grey Personality?</h3>
        </div>
