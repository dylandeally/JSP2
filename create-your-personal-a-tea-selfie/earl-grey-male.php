...
<html>
<head>
  <title>Earl Grey | Personal-a-Tea Selfie</title>
  ...
  <link rel="stylesheet" type="text/css" href="traits-earl-grey-male.css">
  ...
  <script>
    function checkAvatar() {
      ...
      if (persa == 4 && persb == 0  && persc == 3  && persd == 1 ) {
    ...
    <div id=background-image> 
      ...
      <div class="buttons-gender">
        <ul>
          ...
          <li><a href="earl-grey-female.php" class="round red" id="female-but">Female<span class="round"> <h1>:D</h1> </span></a></li>
        </ul> 
      </div> <!--buttons-gender-->
      ...
      <div class="buttons-drink">
        <ul>                  
          ...
          <li>
            <a href="earl-grey-male.php" id="eg-but" class="current round yellow"><div id="eg-but-text">Earl Grey</div>
              <span class="round">
        ...
        <div id="desRadio" class="desRadio" name="desRadio">
          ...
          <form name="fdesign">
            <ul>
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(earl-grey-hongoram-male.jpg)'; 
                  getElementById('personality-a').style.color = '#60bd8d'; 
                  getElementById('personality-b').style.color = '#60bd8d'; 
                  getElementById('personality-c').style.color = '#60bd8d'; 
                  getElementById('personality-d').style.color = '#60bd8d'; 
                  getElementById('nameMugArea').style.color = '#60bd8d'">
              ...
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(earl-grey-nostalgia-male.jpg)'; 
              ...
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(earl-grey-paupau-male.jpg)'; 
                  getElementById('personality-a').style.color = '#cd4428'; 
                  getElementById('personality-b').style.color = '#cd4428'; 
                  getElementById('personality-c').style.color = '#cd4428'; 
                  getElementById('personality-d').style.color = '#cd4428'; 
                  getElementById('nameMugArea').style.color = '#cd4428'">
