...
<html>
<head>
  <title>Cappuccina | Personal-a-Tea Selfie</title>
  ...
  <link rel="stylesheet" type="text/css" href="traits-cappuccina.css">
  ...
  <script type="text/javascript" >
    function writeComment(e) {
        ...
        document.getElementById('nameMugArea').innerHTML = comment + " Cappuccina";
        e.preventDefault();
        return false;
    } 
  </script>
  ...
  <script>
    function checkAvatar() {
      ...
      if (persa == 0 && persb == 0  && persc == 1  && persd == 3 ) {
...
<!----------------------------------------------------Begining of landing page---------------------------------->
  ...
  <div id="avatar-generator">
    ...
    <div id=background-image>
                        <!--Top Image-->
    <img style="max-width:100%;" src="images/top-logo-pink-white.png">

     
    
      <form name="fdrink">
        <input type="hidden" name="drink" id="drink" value="Cappuccina">
      </form>
      ...
      <div class="buttons-gender">
        <ul>
          <li><a href="cappuccino.php" class="round green" id="male-but">Male<span class="round"> <h1>:D</h1> </span></a></li>
      ...
      <div class="buttons-drink">
        <ul>                  
          <li>
            <a href="cappuccina.php" id="cap-but" class="current3 round yellow"><div id="cap-but-text">Cappuccino</div>
              <span class="round">
        ...
        <div id="desRadio" class="desRadio" name="desRadio">
          ...
          <form name="fdesign">
            <ul>
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(cappuccina-digital-light.jpg)'; 
              ...
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(cappuccina-digital-dark.jpg)'; 
              ...
              <li>
                <a onclick="
                  getElementById('design').style.backgroundImage = 'url(cappuccina-organic.jpg)'; 
          ...
          <div class="radio-container" name="radio-container" >
            ...
            <div id="p1">
              <form name="fpersa">
                <ul>
                  <li id="li-top">
                    <a onclick="getElementById('personality-a').innerHTML = 'Full of Life'" >
                      <input type="radio" id="a1-option" name="personalitya" value="Full of Life" >
                      <label for="a1-option">FullOfLife</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  ...
                  <li>
                    <a onclick="getElementById('personality-a').innerHTML = 'Busy'">
                      <input type="radio" id="a3-option" name="personalitya" value="Busy"> 
                      <label for="a3-option">Busy</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a onclick="getElementById('personality-a').innerHTML = 'Curious'">
                      <input type="radio" id="a5-option" name="personalitya" value="Curious"> 
                      <label for="a5-option">Curious</label>
                      <div class="check"></div>
                    </a>
                  </li>
                </ul>
          ...
          <div class="radio-container" name="radio-container">
            ...
            <div id="p2">
              <form name="fpersb">
                <ul>
                  <li id="li-top" >
                    <a onclick="getElementById('personality-b').innerHTML = 'Gentle'" >
                      <input type="radio" id="b1-option" name="personalityb" value="Gentle" >
                      <label for="b1-option">Gentle</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li>
                    <a onclick="getElementById('personality-b').innerHTML = 'Loving'">
                      <input type="radio" id="b2-option" name="personalityb" value="Loving"> 
                      <label for="b2-option">Loving</label>
                      <div class="check"></div>
                    </a>
                  </li>
          
                  <li>
                    <a onclick="getElementById('personality-b').innerHTML = 'Caring'">
                      <input type="radio" id="b3-option" name="personalityb" value="Caring"> 
                      <label for="b3-option">Caring</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-b').innerHTML = 'Creative'">
                      <input type="radio" id="b4-option" name="personalityb" value="Creative"> 
                      <label for="b4-option">Creative</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-b').innerHTML = 'Adventurer'">
                      <input type="radio" id="b5-option" name="personalityb" value="Adventurer"> 
                      <label for="b5-option">Adventurer</label>
                      <div class="check"></div>
                    </a>
                  </li>
                </ul>
            ...
            <div id="p3">
              <form name="fpersc">
                <ul>
                  ...
                  <li>
                    <a onclick="getElementById('personality-c').innerHTML = 'Dreamer'">
                      <input type="radio" id="c2-option" name="personalityc" value="Dreamer"> 
                      <label for="c2-option">Dreamer</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  ...
                  <li>
                    <a onclick="getElementById('personality-c').innerHTML = 'Fun'">
                      <input type="radio" id="c3-option" name="personalityc" value="Fun"> 
                      <label for="c3-option">Fun</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-c').innerHTML = 'Stubborn'">
                      <input type="radio" id="c4-option" name="personalityc" value="Stubborn"> 
                      <label for="c4-option">Stubborn</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  <li>
                    <a onclick="getElementById('personality-c').innerHTML = 'Honest'">
                      <input type="radio" id="c5-option" name="personalityc" value="Honest"> 
                      <label for="c5-option">Honest</label>
                      <div class="check"></div>
                    </a>
                  </li>
                </ul>
          ...
          <div class="radio-container" name="radio-container">
            ...
            <div id="p4">
              <form name="fpersd">
                <ul>
                  <li id="li-top">
                    <a onclick="getElementById('personality-d').innerHTML = 'Trustworthy'" >
                      <input type="radio" id="d1-option" name="personalityd" value="Trustworthy" >
                      <label for="d1-option">Trustworthy</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  ...
                  <li id="li-top">
                    <a onclick="getElementById('personality-d').innerHTML = 'Optimistic'">
                      <input type="radio" id="d2-option" name="personalityd" value="Optimistic"> 
                      <label for="d2-option">Optimistic</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  ...
                  <li id="li-top">
                    <a onclick="getElementById('personality-d').innerHTML = 'Multi-tasker'">
                      <input type="radio" id="d4-option" name="personalityd" value="Multi-tasker"> 
                      <label for="d4-option">Multi-tasker</label>
                      <div class="check"></div>
                    </a>
                  </li>
                  
                  <li id="li-top">
                    <a onclick="getElementById('personality-d').innerHTML = 'Inclusive'">
                      <input type="radio" id="d5-option" name="personalityd" value="Inclusive"> 
                      <label for="d5-option">Inclusive</label>
                      <div class="check"></div>
                    </a>
                  </li>
                </ul>
