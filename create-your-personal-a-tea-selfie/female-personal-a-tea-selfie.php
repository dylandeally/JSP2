    ...
    <img style="max-width:100%;" src="images/top-logo-pink-white.png">
      ...
      <div class="buttons-gender">
        <ul>
          ...
          <li><a href="cappuccina.php" class="current2 round red" id="female-but">Female<span class="round"> <h1>:D</h1> </span></a></li>
        </ul> 
      </div> <!--buttons-gender-->
            ...
            <div id="p1">
              <form name="fpersa">
                <ul>
                  ...
                  <li>
                    <a onclick="getElementById('personality-a').innerHTML = 'Dependable'">
